...
<div id="blfix"><div style="position:absolute; display:none;  right: -20px;
  top: -24px; width: 29px;
  height: 29px;
  cursor: pointer;" onClick="document.getElementById('blfix').style.display='none';"><img src="http://mgorod.kz/wp-content/uploads/2015/01/close.png"></div>
<img src="http://mgorod.kz/wp-content/uploads/2015/06/dent1.jpg">
</div>


<div class="mfo" id="mfo" style="display:none;">
...
<script>
    ...
    addOnWheel(text, function(e) {
 	...
 	<div style="width:880px; height:110px; overflow:hidden; margin: 20px;">
