...
<div id="comments" class="comments-area" style="  margin: 30px 0 0 0 !important;">
    ...
    $args = array(
        ...
        'comment_field' => '<p class="comment-form-comment"><textarea id="comment" rows="6" name="comment" aria-required="true" style="width:647px !important;"></textarea></p><p class="comment-form-rule"><input type="checkbox" checked="checked" name="comment_rule" id="comment_rule"><label for="comment_rule">Согласен с <a href="/pravila-polzovaniya-sajta/" target="_blank">условиями сайта</a></label></p>',
